...
class SidebarFilter extends Component {
    ...
    render() {
        ...
        return (
            <div className="col-lg-3 col-md-12 sidebar mt-5 mt-lg-0">
                 {/* Categories Filter */}
                <div className="widget">
                    <h5 className="widget-title">Categories</h5>
                    <ul className="categories-widget list-unstyled">
                ...
                {/* Color Filter */}
                <div className="widget filter-color">
                            ...
                            return (
                                <li key={index}>
                                    <div className="form-check pl-0">
                                        <input type="checkbox" onClick={(e) => this.ColorFilter(e, colorsFilterValues)} value={col} defaultChecked={colorsFilterValues.includes(col) ? true : false} className="form-check-input" id={col} name="ExampleRadios" />
                                        <label className="form-check-label" htmlFor={col} style={{ background: col }}  style={{backgroundColor: `${col}`}} />
                                    </div>
                                </li>
                            )
                        })}
