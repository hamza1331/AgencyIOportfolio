...
class Listview extends Component {
    ...
    render() {
        ...
        return (
            <div className="product-item product-list mb-5">
                ...
                <div className="row align-items-center">
                    ...
                    <div className="col-lg-8 col-md-7">
                        <div className="product-desc">
                            ...
                            <Link to="/product-single" className="product-name">{productdata.name}</Link>
                            <div className="product-price">${productdata.price}<span> ${productdata.salePrice}</span></div>
                            <p className="mt-2 mb-0">{productdata.description}</p>
                        </div>
                    </div>
                    {isOpen && (
                        <Lightbox
